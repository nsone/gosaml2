...
# Build fuzzers
compile_native_go_fuzzer github.com/nsone/gosaml2/internal/fuzz FuzzDecodeResponse fuzz_decode_response
compile_native_go_fuzzer github.com/nsone/gosaml2/internal/fuzz FuzzLogoutResponse fuzz_logout_response
compile_native_go_fuzzer github.com/nsone/gosaml2/internal/fuzz FuzzBuildRequest fuzz_build_request
